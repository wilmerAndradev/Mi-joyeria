    ...
    <div className="min-h-screen bg-black pt-32 pb-24">
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-gold mb-6">Garantía y Devoluciones</h1>
          <p className="text-gold/60 text-sm">Garantía de Excelencia LUMIÈRE</p>
        </div>
        ...
        <div className="prose prose-lg prose-headings:font-serif prose-headings:text-gold prose-p:text-gold/80 prose-a:text-gold max-w-none">
          <p className="lead text-xl text-gold/90 mb-8">
            En LUMIÈRE Joyería, respaldamos la calidad y la artesanía excepcional de cada pieza que creamos. Nuestra política de garantía y devoluciones está diseñada para brindarle total tranquilidad en su inversión.
          </p>
          ...
          <p className="mt-4">
            Esta garantía no cubre el desgaste natural por el uso diario, daños accidentales (como golpes o caídas), pérdida de gemas o diamantes debida a daños en la montura, ni cualquier alteración o reparación realizada por joyeros externos a LUMIÈRE.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8">
            ...
            <li>Debe incluirse el estuche original de LUMIÈRE, todos los certificados de gemas (si aplica) y la boleta o factura de compra.</li>
          ...
          <ol className="list-decimal pl-6 space-y-2 mb-8">
            <li>Contacte a nuestro equipo de Atención al Cliente a través del correo <strong>devoluciones@lumierejoyeria.cl</strong> o mediante WhatsApp indicando su número de pedido.</li>
          ...
          <p>
            Como cliente de LUMIÈRE, usted tiene derecho a una limpieza profesional y revisión de engastes gratuita una vez al año por cada joya adquirida en nuestra tienda.
          </p>
        </div>
      </div>
    </div>
