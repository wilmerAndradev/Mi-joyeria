...
export function WhatsAppWidget() {
  ...
  const defaultMessage = "Hola Aleafar, me interesa consultar sobre...";
          ...
          >
            ...
            <div className="bg-gold p-5 flex items-center justify-between relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="flex flex-col">
                  <h3 className="text-white font-semibold tracking-wide text-base leading-tight drop-shadow-sm">Aleafar Joyería</h3>
            ...
            <div className="p-6 bg-[#f8f7f5] relative min-h-[120px]">
              ...
              >
                ...
                <p className="text-sm text-charcoal mt-1.5 leading-relaxed font-normal">¿En qué podemos ayudarte a brillar hoy?</p>
        ...
        <AnimatePresence mode="wait">
          {isOpen ? (
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 md:w-7 md:h-7 text-white drop-shadow-sm">
